...
const KTWizard = function(elementId, options) {
    ...
    var Plugin = {
        ...
        build() {
            ...
            if (the.options.clickableSteps === true) {
                KTUtil.on(element, '[data-wizard-type="step"]', 'click', function() {
                    const index = KTUtil.index(this) + 1;
        ...
        updateUI() {
            ...
            // Steps
            const steps = KTUtil.findAll(the.element, '[data-wizard-type="step"]');
            ...
            // Steps Info
            const stepsInfo = KTUtil.findAll(the.element, '[data-wizard-type="step-info"]');
            ...
            // Steps Content
            const stepsContent = KTUtil.findAll(the.element, '[data-wizard-type="step-content"]');
